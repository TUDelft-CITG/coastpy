...
class RegionOfInterestMaskTransform(BaseTransform):
    """Bitmask for region of interest (classes 1, 2, 3 → 1; 0 → 0; NaNs preserved)."""
...
class LandwardMaskTransform(BaseTransform):
    """Bitmask for landward point (class 2 → 1; else → 0; NaNs preserved)."""
...
class SeawardMaskTransform(BaseTransform):
...
class TransformFactory:
    ...
    _registry: dict[str, type[BaseTransform]] = {
        ...
        "roi_mask": RegionOfInterestMaskTransform,
        "landward_mask": LandwardMaskTransform,
        "seaward_mask": SeawardMaskTransform,
    }
